% ********************************************
\subsection{Module 1: Long-Term Waiting List Management\label{sec:waitinglist}}
% *******************************************

CMP is the strategic decision layer that decides the volumes of elective surgeries to be performed over a given planning horizon, see Section~\ref{sec:lit_review}. 
...
% *******************************************
\subsubsection{$(R,Q)$ surgery scheduling policy: long-term distributions\label{sec:rqtheory}}
% *******************************************
...
% ********************************************
\subsubsection{The dynamics of process $\stocprocbatches{\stocprocperiod}, \, \stocprocperiod \ge 0$\label{sec:batchprocess}}
% *******************************************
...
% ********************************************
\subsubsection{Upper and lower bounds on the batch size $\batchsizeq$ under waiting time requirements} \label{sec:bounds}
% *******************************************
...
To verify the waiting time requirements when $\stocprocbatches{\stocprocperiod} = 0$, one can apply \eqref{eq:upperbound}, which implies that $P(\omega \le 6 | \stocprocbatches{\stocprocperiod} = 0) = 0.171625^6 \approx 2.5 \cdot 10^{-5} < 0.05$. Therefore, to find the bound $\overline Q$ in Eq. \eqref{eq:overbound}, we must iterate on higher values of $Q$.
