...
\newcommand{\rqmodule}{Queue Management}
\newcommand{\overtimemodule}{Overtime and Cancellation}
\newcommand{\preprocessmodule}{Preprocessing of strategic input / block-demand conversion}
\newcommand{\otschedmodule}{Operating Theatre Scheduling}
...
\newcommand{\pmf}[1]{\ensuremath{\mathit{pmf}}_{#1}}
\newcommand{\durationpmf}[1]{{\ensuremath{\mathit{surg\_pmf}}_{#1}}}
...
\newcommand{\cumulativeduration}[1]{cd_{#1}}
\newcommand{\numcompletedsurgs}{K}
\newcommand{\blocksurgpmf}[1]{{\ensuremath{\mathit{block\_pmf}}_{#1}}}
...
\newcommand{\cancellationfunction}{\ensuremath{\mathit{cost}}}

% auxiliary algorithm output
\newcommand{\cumulconvo}[1]{\ensuremath{cumul}^{(#1)}}
...
\newcommand{\blockmset}{\mathcal{B}^{\prime}}
...
\newcommand{\numbersanests}{NumAnest}
\newcommand{\needanest}{NeedAnest}
\newcommand{\specteams}{NumTeam}
