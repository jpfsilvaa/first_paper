...
\newcommand{\roomsete}{\mathcal{OT}_{e}}
\newcommand{\roomseta}{\mathcal{OT}_{a}}
\newcommand{\roomset}{\mathcal{OT}}
\newcommand{\roomidx}{ot}
\newcommand{\roomidxalt}{ot'}

\newcommand{\specialtyset}{\mathcal{Spec}}
\newcommand{\specialtymset}{\mathcal{\specialtyset}_{seq}}   % especialidades que precisam de dois blocos
\newcommand{\specialtycset}{\mathcal{\specialtyset}_{circ}}  % especialidades circunstanciais
\newcommand{\specialtyprset}{\mathcal{\specialtyset}_{prio}} % especialidades prioritárias
\newcommand{\specialtytxset}{\mathcal{\specialtyset}_{tx}}% especialidades de transplante
