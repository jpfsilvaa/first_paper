...
Still on the uncertainty treatment, disregarding it in the duration of surgeries often results in idle time and unpredictable overtime in operating rooms, as well as delays in procedures, among other effects~\citep{shehadeh2022stochastic}. 
...
{\color{red} Relendo, aqui abaixo meio que se perdeu um pouco do foco sobre falar de over/idle time... Vou rever}
Works such as from~\citet{Barz2015} address a tactical patient admission and scheduling problem in which the hospital decides a CMP under multiple resource constraints and stochastic clinical progression. 
