...
\begin{itemize}
    ...
    \item Cancellation and overtime management through a Newsvendor model that determines an optimal time budget for the last surgery in a session, based on the random duration of this surgery. That way, we can estimate the number of surgeries to happen in the session by an inventory model
