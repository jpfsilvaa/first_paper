...
Surgical scheduling decisions are organized into time-based planning levels, and one can consider different uncertainty factors on each of them~\citep{Rahimi2020Review}.
At the strategic level, long-term decisions define hospital resource capacity and its allocation across medical specialities~\citep{Rahimi2020Review}.
...
From strategic to operational levels, decisions are inherently interconnected.
Therefore, CMP must be the first step towards an integrated surgical scheduling framework~\citep{deMello2013Integrated}.
